package payment.alipay.demo;

import com.alipay.trade.model.GoodsDetail;
import payment.alipay.core.AlipayCore;
import payment.alipay.model.*;
...
public class ApiDemo {
    ...
    public static void pay(){
        ...
        input.setAuthCode("281603777770647596");
    ...
    public static void  refund(){
        ...
        input.setOutTradeNo("5113811987100800791");
        input.setTradeNo("2017071221001004510227789747");
        input.setRefundAmount("0.01");
        input.setRefundReason("测试退款");
        input.setStoreId("00001815100023");
        input.setTerminalId("10007");
        alipayCore.refund(input);
    }

    public static void query(){
        alipayCore.query("5113811987100800791");
    }
