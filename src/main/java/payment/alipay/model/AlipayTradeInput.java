...
public class AlipayTradeInput {
    ...
    private String totalAmount;// (必填) 订单总金额，单位为元，不能超过1亿元
    private String authCode;//(必填) 付款条码，用户支付宝钱包手机app点击“付款”产生的付款条码
    ...
    private String body;// 订单描述，可以对交易或商品进行一个详细地描述，比如填写"购买商品3件共20.00元"
